  ...
  <div id="app" class="container-fluid py-3">
    <template v-if="data">
      ...
      <div class="row">
        <div class="col-6 col-md">
          <div class="card card-body border-0 shadow-sm mb-4">
            <h3 class="card-title text-info low display-4 font-weight-normal">{{ getStats('Suspected_24') | numberFormat }}</h3>
            <p class="card-text mb-0">SUSPECTED</p>
          </div>
        </div>
        <div class="col-6 col-md">
          <div class="card card-body border-0 shadow-sm mb-4">
            <h3 class="card-title text-primary low display-4 font-weight-normal">{{ getStats('Tested_24') | numberFormat }}</h3>
            <p class="card-text">TESTED</p>
          </div>
        </div>
        <div class="col-6 col-md">
          <div class="card card-body border-0 shadow-sm mb-4">
            <h3 class="card-title text-danger low display-4 font-weight-normal">{{ getStats('Confirmed_24') | numberFormat }}</h3>
            <p class="card-text">CONFIRMED</p>
          </div>
        </div>
        <div class="col-6 col-md">
          <div class="card card-body border-0 shadow-sm mb-4">
            <h3 class="card-title text-warning low display-4 font-weight-normal">{{ getStats('Admitted_24') | numberFormat }}</h3>
            <p class="card-text">ADMITTED</p>
          </div>
        </div>
        <div class="col-6 col-md">
          <div class="card card-body border-0 shadow-sm mb-4">
            <h3 class="card-title text-success low display-4 font-weight-normal">{{ getStats('Discharged_24') | numberFormat }}</h3>
            <p class="card-text">DISCHARGED</p>
          </div>
        </div>
        <div class="col-6 col-md">
          <div class="card card-body border-0 shadow-sm mb-4">
            <h3 class="card-title text-danger low display-4 font-weight-normal">{{ getStats('Expired_24') | numberFormat }}</h3>
      ...
      <div class="row mb-4">
        ...
        <div class="col-md-6">
          <div class="card card-body border-0 shadow-sm mb-4">
            <h6 class="card-title">Cases by Provinces and Date</h6>
...
export default {
  ...
  mounted () {
    Axios.all([
      Axios.get('/latest/',{ headers: { Authorization: `Token ${process.env.VUE_APP_TOKEN}` } }),
      Axios.get('/table/',{ headers: { Authorization: `Token ${process.env.VUE_APP_TOKEN}` } }),
      Axios.get('/query/?measure=Confirmed_Cum&groupby=Date&province=Balochistan&aggregate=Sum',{ headers: { Authorization: `Token ${process.env.VUE_APP_TOKEN}` } }),
      Axios.get('/query/?measure=Confirmed_Cum&groupby=Date&province=Khyber Pakhtunkhwa&aggregate=Sum',{ headers: { Authorization: `Token ${process.env.VUE_APP_TOKEN}` } }),
      Axios.get('/query/?measure=Confirmed_Cum&groupby=Date&province=Punjab&aggregate=Sum',{ headers: { Authorization: `Token ${process.env.VUE_APP_TOKEN}` } }),
      Axios.get('/query/?measure=Confirmed_Cum&groupby=Date&province=Sindh&aggregate=Sum',{ headers: { Authorization: `Token ${process.env.VUE_APP_TOKEN}` } }),
      Axios.get('/query/?measure=Confirmed_Cum&groupby=Date&province=Islamabad&aggregate=Sum',{ headers: { Authorization: `Token ${process.env.VUE_APP_TOKEN}` } }),
      Axios.get('/query/?measure=Confirmed_Cum&groupby=Date&province=Gilgit-Baltistan&aggregate=Sum',{ headers: { Authorization: `Token ${process.env.VUE_APP_TOKEN}` } }),
      Axios.get('/query/?measure=Confirmed_Cum&groupby=Date&province=Azad Kashmir&aggregate=Sum',{ headers: { Authorization: `Token ${process.env.VUE_APP_TOKEN}` } }),
      Axios.get('/query/?measure=Confirmed_Cum&groupby=Date&province=KP Tribal Districts&aggregate=Sum',{ headers: { Authorization: `Token ${process.env.VUE_APP_TOKEN}` } }),
      Axios.get('/query?measure=Suspected_Cum&groupby=Date&aggregate=Sum',{ headers: { Authorization: `Token ${process.env.VUE_APP_TOKEN}` } }),
      Axios.get('/query?measure=Tested_Cum&&groupby=Date&aggregate=Sum',{ headers: { Authorization: `Token ${process.env.VUE_APP_TOKEN}` } }),
      Axios.get('/query?measure=Confirmed_24&aggregate=Sum',{ headers: { Authorization: `Token ${process.env.VUE_APP_TOKEN}` } }),
      Axios.get('/query?measure=Admitted_24&aggregate=Sum',{ headers: { Authorization: `Token ${process.env.VUE_APP_TOKEN}` } }),
      Axios.get('/query?measure=Discharged_24&aggregate=Sum',{ headers: { Authorization: `Token ${process.env.VUE_APP_TOKEN}` } }),
      Axios.get('/query?measure=Expired_24&aggregate=Sum',{ headers: { Authorization: `Token ${process.env.VUE_APP_TOKEN}` } }),
